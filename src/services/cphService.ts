...
export class CphService {
     ...
     */
    syncProblemSampleTests(srcFileName: string, problem: Problem, previousExtra?: ProblemExtra): CphSampleSyncResult {
        if (!problem.extra) {
     ...
     */
    private saveIfChanged(srcFileName: string, previousProb: CphProb, nextProb: CphProb): CphSampleSyncResult {
